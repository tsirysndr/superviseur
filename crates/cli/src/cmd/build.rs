use anyhow::Error;
use superviseur_server::api::superviseur::v1alpha1::{logging_service_client::LoggingServiceClient, control_service_client::ControlServiceClient, BuildRequest, LoadConfigRequest};
use superviseur_types::UNIX_SOCKET_PATH;
use tokio::net::UnixStream;
use tonic::transport::{ Endpoint, Uri};
use tower::service_fn;
use superviseur_server::api::superviseur::v1alpha1::EventsRequest;
use crate::config::verify_if_config_file_is_present;
use owo_colors::OwoColorize;
use superviseur_types::events::*;
