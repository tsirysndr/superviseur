...
use crate::api::superviseur::v1alpha1::{
    logging_service_server::LoggingService, EventsRequest, EventsResponse, LogDetails, LogRequest,
    LogResponse, SearchRequest, SearchResponse, TailRequest, TailResponse,
};
use crate::macros::*;
use anyhow::Error;
...
use superviseur_types::{events::*, process::Process};
