...
## 📦 Downloads
- `Mac`: arm64: [superviseur_v0.1.0-alpha.9_aarch64-apple-darwin.tar.gz](https://github.com/tsirysndr/superviseur/releases/download/v0.1.0-alpha.9/superviseur_v0.1.0-alpha.9_aarch64-apple-darwin.tar.gz) intel: [superviseur_v0.1.0-alpha.9_x86_64-apple-darwin.tar.gz](https://github.com/tsirysndr/superviseur/releases/download/v0.1.0-alpha.9/superviseur_v0.1.0-alpha.9_x86_64-apple-darwin.tar.gz)
- `Linux`: [superviseur_v0.1.0-alpha.9_x86_64-unknown-linux-gnu.tar.gz](https://github.com/tsirysndr/superviseur/releases/download/v0.1.0-alpha.9/superviseur_v0.1.0-alpha.9_x86_64-unknown-linux-gnu.tar.gz)
